    ...
    <div className="min-h-screen bg-white dark:bg-black text-gray-900 dark:text-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pt-28 sm:pt-32 pb-12 sm:pb-16">
        <p className="text-xs sm:text-sm text-gray-400 dark:text-gray-500 mb-6 sm:mb-8">
          ...
          <a href="/#servicios" className="hover:text-gray-900 dark:hover:text-white transition-colors">
            Servicios
          </a>
        </p>
        ...
        <div className="bg-gray-50 dark:bg-white/5 border border-gray-200 dark:border-gray-800 rounded-2xl p-6 sm:p-8 text-center">
          <h2 className="text-xl sm:text-2xl font-bold mb-3 text-gray-900 dark:text-white">
            ¿Quieres una página web para tu negocio?
          </h2>
          <p className="text-gray-600 dark:text-gray-300 mb-6 max-w-lg mx-auto">
            Cuéntame sobre tu proyecto y recibe asesoría sin compromiso. Te ayudo a definir qué tipo de página necesita tu negocio.
          </p>
          <a
            href={WHATSAPP_URL}
            target="_blank"
        ...
        <div className="flex justify-center gap-6 mt-8 sm:mt-10">
          ...
          <a href="/#contacto" className="text-gray-500 dark:text-gray-400 hover:text-gray-900 dark:hover:text-white text-sm transition-colors">

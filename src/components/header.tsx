...
export function Header() {
  ...
  const whatsappButton = (
    <a
      ...
      className="rounded-full bg-[#25D366] text-white px-4 py-2 sm:px-5 sm:py-2.5 flex items-center gap-1.5 sm:gap-2 font-semibold text-xs sm:text-sm hover:bg-[#1da851] transition-all duration-200 hover:scale-105 whitespace-nowrap shadow-sm"
    >
